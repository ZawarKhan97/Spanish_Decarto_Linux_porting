...
void RS1(UART_HandleTypeDef *huart,I2C_HandleTypeDef *hi2c1)
{
   ...
   //i2c1_uh2cd_write32(huart,hi2c1,0x8671, 0x020C49BA); // NCO_48F0A_D
   //i2c1_uh2cd_write32(huart,hi2c1,0x8675, 0x01E1B089); // NCO_44F0A_D
   // i2c1_uh2cd_write8(huart,hi2c1,0x8680, 0x00); // AUD_MODE
    //TestEDID_A1(huart,hi2c1);
...
{
	uint8_t hdmi_status[17];
	i2c1_uh2cd_write8(huart,hi2c1,0x8540, 0xC0); // SYS_FREQ0
	i2c1_uh2cd_write8(huart,hi2c1,0x8541, 0x12); // SYS_FREQ1
	i2c1_uh2cd_write8(huart,hi2c1,0x8A0C, 0xC0); // SYS_FREQ0(CSC)
	i2c1_uh2cd_write8(huart,hi2c1,0x8A0D, 0x12); // SYS_FREQ1(CSC)
	i2c1_uh2cd_write8(huart,hi2c1,0x8593, 0x33); // HV_CLR
	HAL_Delay(100);
	// HDMI Input Video Timing Check (PCLK)
	hdmi_status[0] = i2c1_uh2cd_read8(hi2c1,0x8405); // PX_FREQ0
	hdmi_status[1] = i2c1_uh2cd_read8(hi2c1,0x8406); // PX_FREQ1
	// HDMI Input Video Timing Check (Horizontal Related)
	hdmi_status[2] = i2c1_uh2cd_read8(hi2c1,0x858E); // H_SIZE0
	hdmi_status[3] = i2c1_uh2cd_read8(hi2c1,0x858F); // H_SIZE1
	hdmi_status[4] = i2c1_uh2cd_read8(hi2c1,0x8580); // DE_HPOS0
	hdmi_status[5] = i2c1_uh2cd_read8(hi2c1,0x8581); // DE_HPOS1
	hdmi_status[6] = i2c1_uh2cd_read8(hi2c1,0x8582); // DE_HWID0
	hdmi_status[7] = i2c1_uh2cd_read8(hi2c1,0x8583); // DE_HWID1
	// HDMI Input Video Timing Check (Vertical Related)
	hdmi_status[8] = i2c1_uh2cd_read8(hi2c1,0x8590); // V_SIZE0
	hdmi_status[9] = i2c1_uh2cd_read8(hi2c1,0x8591); // V_SIZE1
	hdmi_status[10] = i2c1_uh2cd_read8(hi2c1,0x8584); // DE_POS_A0
	hdmi_status[11] = i2c1_uh2cd_read8(hi2c1,0x8585); // DE_POS_A1
	hdmi_status[12] = i2c1_uh2cd_read8(hi2c1,0x8586); // DE_POS_B0
	hdmi_status[13] = i2c1_uh2cd_read8(hi2c1,0x8587); // DE_POS_B1
	hdmi_status[14] = i2c1_uh2cd_read8(hi2c1,0x858C); // DE_VWID0
	hdmi_status[15] = i2c1_uh2cd_read8(hi2c1,0x858D); // DE_VWID1
	// HDMI Input Video Timing Check (VSYNC,HSYNC Porarity)
	hdmi_status[16] = i2c1_uh2cd_read8(hi2c1,0x8526); // VI_STATUS1
}
